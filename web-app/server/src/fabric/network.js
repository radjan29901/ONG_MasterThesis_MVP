...
// create car transaction
exports.change_type = async function( id,type)
{
    try {
        ...
        await contract.submitTransaction('changeStatusDonation', id,type);
        console.log('Transaction has been submitted');
...
exports.queryAllDonationsAdmin = async function() {
    try {
        console.log('starting to starting to querying all donations')
        ...
        // Evaluate the specified transaction.
        // queryAllCars transaction - requires no arguments, ex: ('queryAllCars')
        const result = await contract.evaluateTransaction('queryAllDonationsAdmin');
